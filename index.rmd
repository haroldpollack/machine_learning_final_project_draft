...
Somewhat unfortunately, one factor variable—a timestamp—was by far the most important in predicting exercise mode. If I had more time, I would have implemented a cross-validation set to explore the over-fitting issue. It was clear from a simple cross-tab that the time-stamp was super-predictive.
